    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
        <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
            <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                <h2 class="text-3xl font-bold leading-tight text-neutralSilver6 sm:text-4xl">Sign in to Celebration</h2>
                ...
                <form onSubmit={handleSubmit} class="mt-8">
                    <div class="space-y-5">
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input
                                    placeholder="Enter username to get started" type="text" value={username} onChange={(e) => setUsername(e.target.value)}
