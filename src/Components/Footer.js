const Footer =()=>{
    return(
        <section class="py-5 bg-FontColor sm:pt-16 lg:pt-24">
    <div class=" mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12">
            <div>
            <p class="text-lg font-semibold text-neutralSilver6" >Maanfur</p>
            ...
            <div>
                <p class="text-lg font-semibold text-neutralSilver6">Help</p>
            ...
            <div>
                <p class="text-lg font-semibold text-neutralSilver6">Resources</p>
            ...
            <div>
                <p class="text-lg font-semibold text-neutralSilver6">Extra Links</p>
        ...
        <div class="mt-20 md:mt-28 2xl:mt-32">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <p class="mt-6 text-sm text-blue-200 lg:mt-0">© Copyright 2021, All Rights Reserved by Maanfur books</p>
            </div>
        </div>
    </div>
</section>
